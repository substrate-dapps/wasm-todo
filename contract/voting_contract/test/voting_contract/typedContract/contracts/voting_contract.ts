...
import ABI from '../../artifacts/voting_contract.json';
import QueryMethods from '../query/voting_contract';
import BuildExtrinsicMethods from '../build-extrinsic/voting_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/voting_contract';
import MixedMethods from '../mixed-methods/voting_contract';
import EventsClass from '../events/voting_contract';
