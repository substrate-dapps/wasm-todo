...
import ABI from '../../artifacts/todo_list.json';
import QueryMethods from '../query/todo_list';
import BuildExtrinsicMethods from '../build-extrinsic/todo_list';
import TxSignAndSendMethods from '../tx-sign-and-send/todo_list';
import MixedMethods from '../mixed-methods/todo_list';
import EventsClass from '../events/todo_list';
